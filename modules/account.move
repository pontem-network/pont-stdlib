...
module Account {
    ...
    native public fun deposit_from_native<Token>(address: &signer, amount: u128): Pontem::T<Token>;

    native public fun withdraw_to_native<Token>(address: &signer, balance: Pontem::T<Token>);
